;*****************start of the AbeyOS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Hi... This is AbeyOS", 0x00

	wel1 db	'--------------------------------------------', 0x00			

	wel2 db '---------- WELCOME TO AbeyOS ---------', 0x00 
	...
	wel7 db ' version 1.0.0 of AbeyOS By Kavindu Abeywickrama ', 0x00
	...
	strPrompt		db	"AbeyOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Abey", 0x00	;OS details
